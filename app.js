...
const operario       = require('./controller/operario');
const tarea          = require('./controller/tarea');
const articulo   = require('./controller/articulo');
...
app.get('/api/entrega', entrega.pendientes);
app.get('/api/entregadetalle',entrega.detalle);

app.get('/api/operario',operario.trabajador);

app.get('/api/tarea',tarea.list);
app.post('/api/tarea',tarea.add);
app.get('/api/tareaOperario',tarea.listaOperario);

app.get('/api/articuloVerificar',articulo.verificarArticulo);
